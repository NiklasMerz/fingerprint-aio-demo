...
function runNgc(context, configFile) {
    return new Promise(function (resolve, reject) {
        ...
        if (!ngcCmd) {
            reject(new errors_1.BuildError("Unable to find Angular Compiler \"ngc\" command: " + ngcCmd + ". Please ensure @angular/compiler-cli has been installed with NPM."));
            return;
        }
...
function createTmpTsConfig(context, ngcConfig) {
    ...
    if (!tsConfigFile || !tsConfigFile.config) {
        throw new errors_1.BuildError("invalid tsconfig: " + tsConfigPath);
    }
    if (!tsConfigFile.config.compilerOptions) {
        throw new errors_1.BuildError("invalid tsconfig compilerOptions: " + tsConfigPath);
    }
...
function copySrcTsToTmpDir(context) {
    return new Promise(function (resolve, reject) {
        ...
        try {
            ...
            reject(new errors_1.BuildError("tmpDir error: " + e));
            return;
        }
        var copyOpts = {
