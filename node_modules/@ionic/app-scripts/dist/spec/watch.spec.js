...
describe('watch', function () {
    describe('runBuildUpdate', function () {
        it('should get the html file if thats the only one', function () {
            var files = [{
                    event: 'change',
                    filePath: 'file1.html',
                    ext: '.html'
                }];
            var data = watch_1.runBuildUpdate(context, files);
            expect(data.filePath).toEqual('file1.html');
        });
        it('should get the scss file for the filePath over html', function () {
            var files = [{
                    event: 'change',
                    filePath: 'file1.html',
                    ext: '.html'
        ...
        it('should get the ts file for the filePath over the others', function () {
            var files = [{
                    event: 'change',
                    filePath: 'file1.html',
                    ext: '.html'
        ...
        it('should set add event when add and changed files', function () {
            var files = [{
                    event: 'change',
                    filePath: 'file1.ts',
                    ext: '.ts'
        ...
        it('should set unlink event when only unlinked files', function () {
            var files = [{
                    event: 'unlink',
                    filePath: 'file.ts',
                    ext: '.ts'
        ...
        it('should set change event when only changed files', function () {
            var files = [{
                    event: 'change',
                    filePath: 'file.ts',
                    ext: '.ts'
